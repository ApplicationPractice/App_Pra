...
import com.example.myapplication.bean.MediaPickBean;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener , MediaSelector.MediaSelectorListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.setStatusBarColor(this, getResources().getColor(R.color.black));
        ...
        switch (v.getId()){
            case R.id.tv_image:
                ...
                MediaSelector.get(this)
                        ...
                        .setMaxCount(1)//默认最多选择5张，设置单选后此设置无效
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode == MediaSelector.REQUEST_IMAGE && resultCode == RESULT_OK){
            ...
            Log.e("TAG", "size-->" + resultList.get(0));
        }
    }
}